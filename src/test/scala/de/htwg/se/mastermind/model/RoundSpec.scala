...
//        emptyRound.turn.pegString should be("Vector(Color( ), Color( ), Color( ), Color( ))")
//      }
      "have that turn size" in {
        emptyRound.turnSize should be(4)
      }
      "have an empty turnHint" in {
        emptyRound.turnHint.pegString should be("Vector(ColorHint( ), ColorHint( ), ColorHint( ), ColorHint( ))")
      }
